...
\geometry{verbose,tmargin=3.5cm,bmargin=3cm,lmargin=2cm,rmargin=2cm,headheight=3cm,headsep=0.5cm,footskip=1cm}
\usepackage{fancyhdr}
\pagestyle{fancy}
\usepackage{textcomp}
\usepackage{graphicx}
...
\usepackage{fancybox}
\usepackage{outlines} % Easy itemize and enumerate

% Title of the question in bold
\newenvironment{aenumerate}{	\begin{enumerate}\bfseries }{	\end{enumerate} }

% New list, normal font, square before the item, item on the same page
\newcounter{bcounter}
\newenvironment{benumerate}%
{	\normalfont	\begin{list}{$\Box$ \Alph{bcounter}:~}{\usecounter{bcounter} \samepage} }%
{	\end{list}	}

% Change style of the list
\renewcommand{\outlinei}{aenumerate}
\renewcommand{\outlineii}{benumerate}
\renewcommand{\outlineiii}{style}
\renewcommand{\outlineiiii}{style}
...
\newcommand{\background}{/Users/chrisbraissant/Documents/_Diving/Banstec/Logo/Background_white}

% Background
\usepackage{draftwatermark}
\SetWatermarkText{\transparent{0.4}\includegraphics[angle=-45]{\background}}
...
\begin{document}
	...
	\lhead{\textbf{TDI Decompression Procedures}\\ Chapitre \thesection: \rightmark }
	\chead{}
	\rhead{\includegraphics[height=1cm]{\tdi}}

	\lfoot{Chris Braissant}
	\cfoot{}
	\rfoot{\thepage}
